            ...
            <Header />
                <div className="types">
                    <div className="item">
                        ...
                        <Button
                            className="categoriesBtn" id="burgers"
                            onClick={() => setMenu(burger)}>
                            Almoço/Jantar
                        </Button>
                   
                        <Button
                            className="categoriesBtn" id="accompaniments"
                            onClick={() => setMenu(side)}>
                            Acompanhamentos
                        </Button>

                        <Button
                            className="categoriesBtn" id="drinks"
                                                ...
                                                <div className="flavorsModal">
                                                    ...
                                                    <Button
                                                        ...
                                                        onClick={() => setSelect(
                                                            ...
                                                            {
                                                                ...select,
                                                                "flavor": burgers.filter(item => item.id === 33),
                                                            }
                                                        )}>
                                                        Carne
                                                    </Button>
                                                    <Button
                                                        ...
                                                        onClick={() => setSelect(
                                                            ...
                                                            {
                                                                ...select,
                                                                "flavor": burgers.filter(item => item.id === 34),
                                                            }
                                                        )}>
                                                        Frango
                                                    </Button>
                                                    <Button
                                                        ...
                                                        onClick={() => setSelect(
                                                            ...
                                                            {
                                                                ...select,
                                                                "flavor": burgers.filter(item => item.id === 35),
                                                            }
                                                        )}>
                                                        Vegetariano
                                                    </Button>
